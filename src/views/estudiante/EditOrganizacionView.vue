        ...
        <div class="card-body">
          <form @submit="guardar">            
            ...
            <div class="input-group mb-3">     
              <input type="text" v-model="organizacion_matriz" id="organizacion_matriz" class="form-control" maxlength="100" placeholder="Organización Matriz">
            </div>
            
            <div class="input-group mb-3">     
              <input type="text" v-model="organizacion_departamental" id="organizacion_departamental" class="form-control" maxlength="100" placeholder="Organización Departamental" required>              
            </div>

            
            <div class="input-group mb-3">   
              <input type="text" v-model="organizacion_regional" id="organizacion_regional" class="form-control" maxlength="100" placeholder="Organización Regional" required>              
            </div>
           
            <div class="input-group mb-3">   
              <input type="text" v-model="comunidad_sindicato" id="comunidad_sindicato" class="form-control" maxlength="100" placeholder="Comunidad Sindicato" >              
            </div>

            <div class="input-group mb-3">   
              <input type="text" v-model="datos_complementarios" id="datos_complementarios" class="form-control" maxlength="100" placeholder="Datos Complementarios" >              
            </div>
